  ...
  private void simplePagerStyleInitializer() {
    simplePagerStyle = new com.google.gwt.user.cellview.client.SimplePager.Style() {
      ...
      public String getText() {
        return (".com-google-gwt-user-cellview-client-SimplePager-Style-pageDetails {\n  padding : " + ("4px"+ " " +"8px")  + ";\n  text-align : " + ("center")  + ";\n}\n.com-google-gwt-user-cellview-client-SimplePager-Style-button {\n  padding : " + ("4px")  + ";\n  cursor : " + ("pointer")  + ";\n  cursor : " + ("hand")  + ";\n}\n.com-google-gwt-user-cellview-client-SimplePager-Style-disabledButton {\n  cursor : " + ("default")  + ";\n}\n");
      }
      public java.lang.String button() {
        return "com-google-gwt-user-cellview-client-SimplePager-Style-button";
      }
      public java.lang.String disabledButton() {
        return "com-google-gwt-user-cellview-client-SimplePager-Style-disabledButton";
      }
