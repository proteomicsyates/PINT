...
public class MoleculesTable_MoleculesTableResource_default_InlineClientBundleGenerator implements org.reactome.web.diagram.context.dialogs.molecules.MoleculesTable.MoleculesTableResource {
  private static MoleculesTable_MoleculesTableResource_default_InlineClientBundleGenerator _instance0 = new MoleculesTable_MoleculesTableResource_default_InlineClientBundleGenerator();
  ...
  private void dataGridStyleInitializer() {
    dataGridStyle = new org.reactome.web.diagram.context.dialogs.molecules.MoleculesTable.MoleculesTableResource.MoleculesStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridWidget {\n  background-color : " + ("transparent")  + " !important;\n  font-size : " + ("smaller")  + ";\n  cursor : " + ("default")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridFooter {\n  color : " + ("black")  + ";\n  border-top : " + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";\n  text-align : " + ("right")  + ";\n  overflow : " + ("hidden")  + ";\n  white-space : " + ("nowrap")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridHeader {\n  color : " + ("black")  + ";\n  border-bottom : " + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";\n  text-align : ") + (("right")  + ";\n  overflow : " + ("hidden")  + ";\n  white-space : " + ("nowrap")  + ";\n  padding : " + ("0")  + ";\n  text-shadow : " + ("none")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridCell {\n  font-size : " + ("smaller")  + ";\n  border : " + ("none")  + ";\n  overflow : " + ("hidden")  + ";\n  white-space : " + ("nowrap")  + ";\n  text-overflow : " + ("ellipsis")  + ";\n  padding : " + ("0") ) + (";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridSortableHeader {\n  cursor : " + ("pointer")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridSortableHeader:hover {\n  color : " + ("#6c6b6b")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridEvenRow {\n  background : " + ("rgba(" + "100"+ ","+ " " +"100"+ ","+ " " +"200"+ ","+ " " +"0.5" + ")")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridOddRow {\n  background : " + ("rgba(" + "150"+ ","+ " " +"150"+ ","+ " " +"250"+ ","+ " " +"0.5" + ")")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridHoveredRow {\n  color : " + ("black")  + ";\n  background : " + ("rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"0.5" + ")")  + ";\n  cursor : " + ("pointer")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridKeyboardSelectedRow {\n  color : " + ("black")  + ";\n  background : " + ("rgba(" + "200"+ ","+ " " +"200"+ ","+ " " +"200"+ ","+ " " +"0.5" + ")")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridSelectedRow {\n  background : " + ("#628cd5")  + ";\n  color : ") + (("white")  + ";\n  height : " + ("auto")  + ";\n  overflow : " + ("auto")  + ";\n}\n")) : ((".org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridWidget {\n  background-color : " + ("transparent")  + " !important;\n  font-size : " + ("smaller")  + ";\n  cursor : " + ("default")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridFooter {\n  color : " + ("black")  + ";\n  border-top : " + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";\n  text-align : " + ("left")  + ";\n  overflow : " + ("hidden")  + ";\n  white-space : " + ("nowrap")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridHeader {\n  color : " + ("black")  + ";\n  border-bottom : " + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";\n  text-align : ") + (("left")  + ";\n  overflow : " + ("hidden")  + ";\n  white-space : " + ("nowrap")  + ";\n  padding : " + ("0")  + ";\n  text-shadow : " + ("none")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridCell {\n  font-size : " + ("smaller")  + ";\n  border : " + ("none")  + ";\n  overflow : " + ("hidden")  + ";\n  white-space : " + ("nowrap")  + ";\n  text-overflow : " + ("ellipsis")  + ";\n  padding : " + ("0") ) + (";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridSortableHeader {\n  cursor : " + ("pointer")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridSortableHeader:hover {\n  color : " + ("#6c6b6b")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridEvenRow {\n  background : " + ("rgba(" + "100"+ ","+ " " +"100"+ ","+ " " +"200"+ ","+ " " +"0.5" + ")")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridOddRow {\n  background : " + ("rgba(" + "150"+ ","+ " " +"150"+ ","+ " " +"250"+ ","+ " " +"0.5" + ")")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridHoveredRow {\n  color : " + ("black")  + ";\n  background : " + ("rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"0.5" + ")")  + ";\n  cursor : " + ("pointer")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridKeyboardSelectedRow {\n  color : " + ("black")  + ";\n  background : " + ("rgba(" + "200"+ ","+ " " +"200"+ ","+ " " +"200"+ ","+ " " +"0.5" + ")")  + ";\n}\n.org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridSelectedRow {\n  background : " + ("#628cd5")  + ";\n  color : ") + (("white")  + ";\n  height : " + ("auto")  + ";\n  overflow : " + ("auto")  + ";\n}\n"));
      }
      public java.lang.String dataGridCell() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridCell";
      }
      public java.lang.String dataGridEvenRow() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridEvenRow";
      }
      public java.lang.String dataGridEvenRowCell() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridEvenRowCell";
      }
      public java.lang.String dataGridFirstColumn() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridFirstColumn";
      }
      public java.lang.String dataGridFirstColumnFooter() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridFirstColumnFooter";
      }
      public java.lang.String dataGridFirstColumnHeader() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridFirstColumnHeader";
      }
      public java.lang.String dataGridFooter() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridFooter";
      }
      public java.lang.String dataGridHeader() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridHeader";
      }
      public java.lang.String dataGridHoveredRow() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridHoveredRow";
      }
      public java.lang.String dataGridHoveredRowCell() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridHoveredRowCell";
      }
      public java.lang.String dataGridKeyboardSelectedCell() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridKeyboardSelectedCell";
      }
      public java.lang.String dataGridKeyboardSelectedRow() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridKeyboardSelectedRow";
      }
      public java.lang.String dataGridKeyboardSelectedRowCell() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridKeyboardSelectedRowCell";
      }
      public java.lang.String dataGridLastColumn() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridLastColumn";
      }
      public java.lang.String dataGridLastColumnFooter() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridLastColumnFooter";
      }
      public java.lang.String dataGridLastColumnHeader() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridLastColumnHeader";
      }
      public java.lang.String dataGridOddRow() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridOddRow";
      }
      public java.lang.String dataGridOddRowCell() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridOddRowCell";
      }
      public java.lang.String dataGridSelectedRow() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridSelectedRow";
      }
      public java.lang.String dataGridSelectedRowCell() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridSelectedRowCell";
      }
      public java.lang.String dataGridSortableHeader() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridSortableHeader";
      }
      public java.lang.String dataGridSortedHeaderAscending() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridSortedHeaderAscending";
      }
      public java.lang.String dataGridSortedHeaderDescending() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridSortedHeaderDescending";
      }
      public java.lang.String dataGridWidget() {
        return "org-reactome-web-diagram-context-dialogs-molecules-MoleculesTable-MoleculesTableResource-MoleculesStyle-dataGridWidget";
      }
    }
    ;
  }
  private static class dataGridStyleInitializer {
    ...
    static org.reactome.web.diagram.context.dialogs.molecules.MoleculesTable.MoleculesTableResource.MoleculesStyle get() {
      return dataGridStyle;
    }
  }
  public org.reactome.web.diagram.context.dialogs.molecules.MoleculesTable.MoleculesTableResource.MoleculesStyle dataGridStyle() {
  ...
  private static org.reactome.web.diagram.context.dialogs.molecules.MoleculesTable.MoleculesTableResource.MoleculesStyle dataGridStyle;
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      ...
      case 'dataGridStyle': return this.@org.reactome.web.diagram.context.dialogs.molecules.MoleculesTable.MoleculesTableResource::dataGridStyle()();
    }
    return null;
  }-*/;
}
