...
public class HideableContainerPanel_Resources_default_InlineClientBundleGenerator implements org.reactome.web.fireworks.controls.settings.HideableContainerPanel.Resources {
  ...
  private void aboutThisInitializer() {
    aboutThis = new com.google.gwt.resources.client.TextResource() {
      // jar:file:/C:/Users/salvador/.m2/repository/org/reactome/web/fireworks/1.3.7/fireworks-1.3.7.jar!/org/reactome/web/fireworks/controls/settings/tabs/aboutFireworks.html
      public String getText() {
        return "<div style=\"text-align: justify;\">\n    <p>\n        <dt><b>What is this?</b></dt>\n            <p>A genome-wide, hierarchical visualisation of Reactome pathways in a space-filling graph.</p>\n        <dt><b>What is the aim?</b></dt>\n        <p>Visualisation of genome-scale pathway analysis results, allowing both a quick “first glance”\n                and rapid zooming in on interesting results.</p>\n    </dl>\n    <p style=\"text-align: justify;\">\n        The pathways overview offers an intuitive overview of dataset analysis results in the context of\n        the Reactome hierarchical pathway structure, allowing both a quick “first glance” and rapid zooming\n        in on interesting results.\n    </p>\n\n    More information and documentation:\n    <ul style=\"list-style-type:square\">\n        <li>\n            <a href=\"http://wiki.reactome.org/index.php/Usersguide#Pathways_Overview_Display\" target=\"_blank\">Pathways overview</a>\n        </li>\n        <li>\n            <a href=\"http://wiki.reactome.org/index.php/Usersguide#Pathways_Overview_and_Analysis_Results\">Pathways overview analysis result overlay</a>\n        </li>\n    </ul>\n</div>\n\n\n\n\n\n";
      }
  ...
  private void getCSSInitializer() {
    getCSS = new org.reactome.web.fireworks.controls.settings.HideableContainerPanel.ResourceCSS() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-wrapper {\n  width : " + ("300px")  + ";\n  height : " + ("300px")  + ";\n  border : " + ("2px"+ " " +"solid"+ " " +"#1e95cf")  + ";\n  background-color : " + ("#58c3e5")  + ";\n  background : " + ("-webkit-linear-gradient(" + "135deg"+ ","+ " " +"#58c3e5"+ ","+ " " +"#1e94d0" + ")")  + ";\n  background : " + ("-o-linear-gradient(" + "135deg"+ ","+ " " +"#58c3e5"+ ","+ " " +"#1e94d0" + ")")  + ";\n  background : " + ("-moz-linear-gradient(" + "135deg"+ ","+ " " +"#58c3e5"+ ","+ " " +"#1e94d0" + ")")  + ";\n  background : " + ("linear-gradient(" + "135deg"+ ","+ " " +"#58c3e5"+ ","+ " " +"#1e94d0" + ")")  + ";\n  opacity : " + ("0.95")  + ";\n  color : " + ("white")  + ";\n  position : ") + (("relative")  + ";\n  border-radius : " + ("15px"+ " " +"0"+ " " +"0"+ " " +"15px")  + ";\n  float : " + ("right")  + ";\n  overflow : " + ("visible")  + ";\n  font-family : " + ("Arial"+ " " +"Unicode"+ " " +"MS"+ ","+ " " +"Arial"+ ","+ " " +"sans-serif")  + " !important;\n  -webkit-transition : " + ("width"+ " " +"0.3s"+ " " +"ease")  + ";\n  -moz-transition : " + ("width"+ " " +"0.3s"+ " " +"ease")  + ";\n  -o-transition : " + ("width"+ " " +"0.3s"+ " " +"ease")  + ";\n  transition : " + ("width"+ " " +"0.3s"+ " " +"ease")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-wrapperInitial, .org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-wrapper:hover {\n  width : " + ("310px")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-wrapperExpanded {\n  width : " + ("590px") ) + (" !important;\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-outerPanel {\n  float : " + ("right")  + ";\n  width : " + ("100%")  + ";\n  height : " + ("100%")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-buttonsPanel {\n  float : " + ("right")  + ";\n  width : " + ("24px")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-buttonsPanel button {\n  color : " + ("white")  + ";\n  border-radius : " + ("10px"+ " " +"0"+ " " +"0"+ " " +"10px")  + ";\n  background : " + ("none"+ " " +"#58c3e5")  + ";\n  font-size : " + ("medium")  + ";\n  padding : " + ("0"+ " " +"2px"+ " " +"0"+ " " +"2px")  + " !important;\n  outline : ") + (("none")  + ";\n  width : " + ("100%")  + ";\n  height : " + ("80px")  + ";\n  float : " + ("left")  + ";\n  -webkit-transition : " + ("width"+ " " +"0.2s"+ " " +"ease-in-out")  + ";\n  -moz-transition : " + ("width"+ " " +"0.2s"+ " " +"ease-in-out")  + ";\n  -o-transition : " + ("width"+ " " +"0.2s"+ " " +"ease-in-out")  + ";\n  transition : " + ("width"+ " " +"0.2s"+ " " +"ease-in-out")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-buttonsPanel button:hover {\n  color : " + ("white")  + ";\n  background : " + ("none"+ " " +"#58c3e5")  + ";\n  font-size : " + ("medium") ) + (";\n  padding : " + ("0"+ " " +"2px"+ " " +"0"+ " " +"2px")  + " !important;\n  outline : " + ("none")  + ";\n  width : " + ("140%")  + ";\n  background : " + ("none"+ " " +"#1e94d0")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-unselectable {\n  -webkit-touch-callout : " + ("none")  + ";\n  -webkit-user-select : " + ("none")  + ";\n  -khtml-user-select : " + ("none")  + ";\n  -moz-user-select : " + ("none")  + ";\n  -ms-user-select : " + ("none")  + ";\n  user-select : " + ("none")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-undraggable {\n  -webkit-user-drag : ") + (("none")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-buttonSelected {\n  background : " + ("none"+ " " +"#066b9e")  + " !important;\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-container {\n  float : " + ("right")  + ";\n  width : " + ("270px")  + ";\n  height : " + ("276px")  + ";\n  overflow : " + ("hidden")  + ";\n  padding : " + ("3px")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-showHide {\n  height : " + ((HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideIcon()).getHeight() + "px")  + ";\n  width : " + ((HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideIcon()).getSafeUri().asString() + "\") -" + (HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideIcon()).getLeft() + "px -" + (HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideIcon()).getTop() + "px  no-repeat") ) + (";\n  outline : " + ("none")  + ";\n  background-repeat : " + ("no-repeat")  + ";\n  border : " + ("0")  + ";\n  cursor : " + ("pointer")  + ";\n  float : " + ("right")  + ";\n  margin : " + ("2px"+ " " +"8px")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-showHide:hover {\n  height : " + ((HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideHoveredIcon()).getHeight() + "px")  + ";\n  width : " + ((HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideHoveredIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideHoveredIcon()).getSafeUri().asString() + "\") -" + (HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideHoveredIcon()).getLeft() + "px -" + (HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideHoveredIcon()).getTop() + "px  no-repeat")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-showHideRight {\n  -ms-transform : ") + (("rotate(" + "180deg" + ")")  + ";\n  -webkit-transform : " + ("rotate(" + "180deg" + ")")  + ";\n  transform : " + ("rotate(" + "180deg" + ")")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-headerLabel {\n  font-size : " + ("medium")  + " !important;\n}\n")) : ((".org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-wrapper {\n  width : " + ("300px")  + ";\n  height : " + ("300px")  + ";\n  border : " + ("2px"+ " " +"solid"+ " " +"#1e95cf")  + ";\n  background-color : " + ("#58c3e5")  + ";\n  background : " + ("-webkit-linear-gradient(" + "135deg"+ ","+ " " +"#58c3e5"+ ","+ " " +"#1e94d0" + ")")  + ";\n  background : " + ("-o-linear-gradient(" + "135deg"+ ","+ " " +"#58c3e5"+ ","+ " " +"#1e94d0" + ")")  + ";\n  background : " + ("-moz-linear-gradient(" + "135deg"+ ","+ " " +"#58c3e5"+ ","+ " " +"#1e94d0" + ")")  + ";\n  background : " + ("linear-gradient(" + "135deg"+ ","+ " " +"#58c3e5"+ ","+ " " +"#1e94d0" + ")")  + ";\n  opacity : " + ("0.95")  + ";\n  color : " + ("white")  + ";\n  position : ") + (("relative")  + ";\n  border-radius : " + ("15px"+ " " +"0"+ " " +"0"+ " " +"15px")  + ";\n  float : " + ("left")  + ";\n  overflow : " + ("visible")  + ";\n  font-family : " + ("Arial"+ " " +"Unicode"+ " " +"MS"+ ","+ " " +"Arial"+ ","+ " " +"sans-serif")  + " !important;\n  -webkit-transition : " + ("width"+ " " +"0.3s"+ " " +"ease")  + ";\n  -moz-transition : " + ("width"+ " " +"0.3s"+ " " +"ease")  + ";\n  -o-transition : " + ("width"+ " " +"0.3s"+ " " +"ease")  + ";\n  transition : " + ("width"+ " " +"0.3s"+ " " +"ease")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-wrapperInitial, .org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-wrapper:hover {\n  width : " + ("310px")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-wrapperExpanded {\n  width : " + ("590px") ) + (" !important;\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-outerPanel {\n  float : " + ("left")  + ";\n  width : " + ("100%")  + ";\n  height : " + ("100%")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-buttonsPanel {\n  float : " + ("left")  + ";\n  width : " + ("24px")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-buttonsPanel button {\n  color : " + ("white")  + ";\n  border-radius : " + ("10px"+ " " +"0"+ " " +"0"+ " " +"10px")  + ";\n  background : " + ("none"+ " " +"#58c3e5")  + ";\n  font-size : " + ("medium")  + ";\n  padding : " + ("0"+ " " +"2px"+ " " +"0"+ " " +"2px")  + " !important;\n  outline : ") + (("none")  + ";\n  width : " + ("100%")  + ";\n  height : " + ("80px")  + ";\n  float : " + ("right")  + ";\n  -webkit-transition : " + ("width"+ " " +"0.2s"+ " " +"ease-in-out")  + ";\n  -moz-transition : " + ("width"+ " " +"0.2s"+ " " +"ease-in-out")  + ";\n  -o-transition : " + ("width"+ " " +"0.2s"+ " " +"ease-in-out")  + ";\n  transition : " + ("width"+ " " +"0.2s"+ " " +"ease-in-out")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-buttonsPanel button:hover {\n  color : " + ("white")  + ";\n  background : " + ("none"+ " " +"#58c3e5")  + ";\n  font-size : " + ("medium") ) + (";\n  padding : " + ("0"+ " " +"2px"+ " " +"0"+ " " +"2px")  + " !important;\n  outline : " + ("none")  + ";\n  width : " + ("140%")  + ";\n  background : " + ("none"+ " " +"#1e94d0")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-unselectable {\n  -webkit-touch-callout : " + ("none")  + ";\n  -webkit-user-select : " + ("none")  + ";\n  -khtml-user-select : " + ("none")  + ";\n  -moz-user-select : " + ("none")  + ";\n  -ms-user-select : " + ("none")  + ";\n  user-select : " + ("none")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-undraggable {\n  -webkit-user-drag : ") + (("none")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-buttonSelected {\n  background : " + ("none"+ " " +"#066b9e")  + " !important;\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-container {\n  float : " + ("left")  + ";\n  width : " + ("270px")  + ";\n  height : " + ("276px")  + ";\n  overflow : " + ("hidden")  + ";\n  padding : " + ("3px")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-showHide {\n  height : " + ((HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideIcon()).getHeight() + "px")  + ";\n  width : " + ((HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideIcon()).getSafeUri().asString() + "\") -" + (HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideIcon()).getLeft() + "px -" + (HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideIcon()).getTop() + "px  no-repeat") ) + (";\n  outline : " + ("none")  + ";\n  background-repeat : " + ("no-repeat")  + ";\n  border : " + ("0")  + ";\n  cursor : " + ("pointer")  + ";\n  float : " + ("left")  + ";\n  margin : " + ("2px"+ " " +"8px")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-showHide:hover {\n  height : " + ((HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideHoveredIcon()).getHeight() + "px")  + ";\n  width : " + ((HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideHoveredIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideHoveredIcon()).getSafeUri().asString() + "\") -" + (HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideHoveredIcon()).getLeft() + "px -" + (HideableContainerPanel_Resources_default_InlineClientBundleGenerator.this.showHideHoveredIcon()).getTop() + "px  no-repeat")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-showHideRight {\n  -ms-transform : ") + (("rotate(" + "180deg" + ")")  + ";\n  -webkit-transform : " + ("rotate(" + "180deg" + ")")  + ";\n  transform : " + ("rotate(" + "180deg" + ")")  + ";\n}\n.org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-headerLabel {\n  font-size : " + ("medium")  + " !important;\n}\n"));
      }
      public java.lang.String buttonSelected() {
        return "org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-buttonSelected";
      }
      public java.lang.String buttonsPanel() {
        return "org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-buttonsPanel";
      }
      public java.lang.String container() {
        return "org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-container";
      }
      public java.lang.String headerLabel() {
        return "org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-headerLabel";
      }
      public java.lang.String outerPanel() {
        return "org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-outerPanel";
      }
      public java.lang.String showHide() {
        return "org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-showHide";
      }
      public java.lang.String showHideRight() {
        return "org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-showHideRight";
      }
      public java.lang.String undraggable() {
        return "org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-undraggable";
      }
      public java.lang.String unselectable() {
        return "org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-unselectable";
      }
      public java.lang.String wrapper() {
        return "org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-wrapper";
      }
      public java.lang.String wrapperExpanded() {
        return "org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-wrapperExpanded";
      }
      public java.lang.String wrapperInitial() {
        return "org-reactome-web-fireworks-controls-settings-HideableContainerPanel-ResourceCSS-wrapperInitial";
      }
    }
    ;
  }
  private static class getCSSInitializer {
    ...
    static org.reactome.web.fireworks.controls.settings.HideableContainerPanel.ResourceCSS get() {
      return getCSS;
    }
  }
  public org.reactome.web.fireworks.controls.settings.HideableContainerPanel.ResourceCSS getCSS() {
  ...
  private static org.reactome.web.fireworks.controls.settings.HideableContainerPanel.ResourceCSS getCSS;
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'aboutTabIcon': return this.@org.reactome.web.fireworks.controls.settings.HideableContainerPanel.Resources::aboutTabIcon()();
      case 'profilesTabIcon': return this.@org.reactome.web.fireworks.controls.settings.HideableContainerPanel.Resources::profilesTabIcon()();
      case 'showHideHoveredIcon': return this.@org.reactome.web.fireworks.controls.settings.HideableContainerPanel.Resources::showHideHoveredIcon()();
      case 'showHideIcon': return this.@org.reactome.web.fireworks.controls.settings.HideableContainerPanel.Resources::showHideIcon()();
      case 'aboutThis': return this.@org.reactome.web.fireworks.controls.settings.HideableContainerPanel.Resources::aboutThis()();
      case 'getCSS': return this.@org.reactome.web.fireworks.controls.settings.HideableContainerPanel.Resources::getCSS()();
    }
    return null;
  }-*/;
}
