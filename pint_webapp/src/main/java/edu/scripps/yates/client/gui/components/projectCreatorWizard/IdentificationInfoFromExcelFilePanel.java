...
public class IdentificationInfoFromExcelFilePanel extends Composite
	...
	public IdentificationInfoFromExcelFilePanel(String sessionID, int importJobID) {
		...
		msRunComboListBox = new ListBox(true);
			...
			serviceAsync.getExcelFileBean(sessionID, importJobID, excelFileWithFormatBean,
					new AsyncCallback<FileTypeBean>() {
						...
						public void onSuccess(FileTypeBean result) {
							...
							SharedDataUtils.excelBeansByExcelFileWithFormatBeansMap.put(excelFileWithFormatBean,
									result);
						}
					});
	 ...
	 *
	 * @param index
	 *            : index of the {@link ScoreTypeBean} of protein scores
	 ...
	 *
	 * @param index
	 *            : index of the {@link ScoreTypeBean} of psm scores
	 * @param psmScorePanel
	 *
	 */
	 ...
	 *
	 * @param index
	 *            : index of the {@link PtmScoreTypeBean} of ptm scores
	 * @param ptmScorePanel
	 *
	 */
	 ...
	 *
	 * @param index
	 *            : index of the {@link ScoreTypeBean} of peptide scores
