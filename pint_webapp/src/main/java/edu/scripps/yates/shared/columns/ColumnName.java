...
public enum ColumnName {
	...
	SEQUENCE_COUNT("Distinct peptide sequences", "Seq #", "Number of different peptide sequences",
			...
			//
			SPECTRUM_COUNT("Spectrum count", "Spec #", "Number of spectrums",
					HorizontalAlignmentSharedConstant.ALIGN_CENTER),
					//
					COVERAGE("Protein sequence coverage", "Cov (%)", "Sequence coverage in %",
							...
							PROTEIN_SEQUENCE_COVERAGE_IMG("Coverage graph", "Protein coverage graph",
									"Graphical representation of sequence coverage",
									HorizontalAlignmentSharedConstant.ALIGN_LEFT),
									//
									PROTEIN_LENGTH("Length", "Length", "Length of the protein sequence",
											HorizontalAlignmentSharedConstant.ALIGN_CENTER),
											//
											MOL_W("Molecular weight", "MolWt", "Protein molecular weight",
													HorizontalAlignmentSharedConstant.ALIGN_CENTER),
													//
													PROTEIN_PI("Isoelectric Point", "PI",
															"Isoelectric point of the protein",
															HorizontalAlignmentSharedConstant.ALIGN_CENTER),
															//
															GENE("Gene name", "Gene", "Associated gene name",
																	HorizontalAlignmentSharedConstant.ALIGN_CENTER),
																	//
																	PROTEIN_AMOUNT("Protein amounts", "Prot. Am.",
																			"Protein amounts", false),
																			//
																			PROTEIN_RATIO("Protein ratios",
																					"Prot. Ratios.",
																					"Protein amount ratios", false,
																					HorizontalAlignmentSharedConstant.ALIGN_CENTER),
																					//
																					PROTEIN_RATIO_SCORE("Ratio score",
																							"Ratio sc.",
																							"Score or confident value associated to the protein ratio",
																							false,
																							HorizontalAlignmentSharedConstant.ALIGN_CENTER),
																							//
																							PSM_AMOUNT("Psm amounts",
																									"Psm. Am.",
																									"Psm amounts",
																									false,
																									HorizontalAlignmentSharedConstant.ALIGN_CENTER),
	...
	PEPTIDE_RATIO_SCORE("Ratio score", "Ratio sc.", "Score or confident value associated to the peptide ratio", false,
			HorizontalAlignmentSharedConstant.ALIGN_CENTER),
			//
			PEPTIDE_SCORE("Peptide scores", "Pep sc.", "Peptide scores", false,
					HorizontalAlignmentSharedConstant.ALIGN_CENTER),
					//
					...
					PEPTIDE_LENGTH("Peptide length", "Len.", "Length of the peptide sequence",
							...
							NUM_PTMS("# Different modifications", "# Modif.", "Number of different modifications",
									HorizontalAlignmentSharedConstant.ALIGN_CENTER),
									//
									NUM_PTM_SITES("# Different modification sites", "# Modif. sites",
											...
											PTM_SCORE("PTM score", "PTM Sc.", "Modification confidence score", false,
													HorizontalAlignmentSharedConstant.ALIGN_CENTER),
													//
													PEPTIDE_PI("Isoelectric Point", "PI",
															"Isoelectric point of the peptide sequence",
															HorizontalAlignmentSharedConstant.ALIGN_CENTER),

	//
															PSM_ID("PSM Identifier", "PSM ID",
																	"Identifier of the Peptide Spectrum Match"),

	//
																	PSM_RUN_ID("Run Identifier", "Run ID",
																			"Identifier of the MS Run in which the PSM was identified"),
																			//
																			PROTEIN_GROUP_TYPE("Protein evidence",
																					"Evidence",
																					"Evidence of the protein: conclusive, non conclusive, ambiguous or indistinghisable",
																					HorizontalAlignmentSharedConstant.ALIGN_CENTER),
																					//
																					NUM_PROTEIN_GROUP_MEMBERS(
																							"# Group members",
																							"# Prot./group",
																							...
																							TAXONOMY("Taxonomy", "Tax",
																									"Taxonomy of the protein",
																									HorizontalAlignmentSharedConstant.ALIGN_CENTER),
																									//
																									PROJECT("Project(s)",
																											"Prj.",
																											"Project or projects in which has been detected"),
																											//
																											CHARGE("Charge",
																													"Z",
																													"Charge state",
																													...
																													PROTEIN_FUNCTION(
																															...
																															SECONDARY_ACCS(
																																	...
																																	"Sec.ACCs.",
																																	"Secondary protein accessions"),
																																	//
																																	POSITION_IN_PROTEIN(
																																			"Start position(s)",
																																			"Start",
																																			"Position or positions of the peptide in the protein sequence",
																																			HorizontalAlignmentSharedConstant.ALIGN_CENTER),
																																			//
																																			CONDITION(
																																					"Experimental condition(s)",
																																					"Condition",
																																					"Experimental condition(s) in which has been detected"),
																																					//
																																					OMIM("OMIM reference",
																																							"OMIM",
																																							"Reference to Online Mendelian Inheritance in Man"),
																																							//
																																							PEPTIDES_TABLE_BUTTON(
																																									"Show peptide sharing table",
																																									"-",
																																									"Button to show the peptide sharing table",
																																									HorizontalAlignmentSharedConstant.ALIGN_CENTER),
																																									//
																																									PEPTIDE_EVIDENCE(
																																											"Peptide evidence",
																																											"evidence",
																																											"Peptide evidence according to its uniqueness",
																																											HorizontalAlignmentSharedConstant.ALIGN_CENTER),
																																											//
																																											UNIPROT_PROTEIN_EXISTENCE(
																																													...
																																													PSM_RATIO_GRAPH(
																																															"Ratio Graph",
																																															"R",
																																															"Graphical representation of the ratio",
																																															false,
																																															HorizontalAlignmentSharedConstant.ALIGN_CENTER), //
																																															PEPTIDE_RATIO_GRAPH(
																																																	"Ratio Graph",
	...
	PATHWAY_ENTITIES_CURATED_FOUND("Curated entities found", "Curated entities found",
			...
			PATHWAY_ENTITIES_CURATED_TOTAL("Total curated entities", "Total curated entities",
					...
					PATHWAY_ID("Pathway ID", "Pathway ID", "Pathway ID",
							HorizontalAlignmentSharedConstant.ALIGN_CENTER),
	...
	PROTEIN_DOMAIN_FAMILIES("Family & Domains", "Family & Domains",
			...
			PROTEIN_MOLECULAR_PROCESSING("Molecular Processing", "Processing",
					...
					PROTEIN_PTM("Protein PTMs", "PTMs",
							"UniProt annnotation for described aminoacid modifications in the protein"), //
							PROTEIN_NATURAL_VARIATIONS("Natural Variations", "Nat. variations",
									...
									PROTEIN_SECONDARY_STRUCTURE("Secondary structure", "Sec. Struct.",
											...
											PROTEIN_EXPERIMENTAL_INFO("Experimental info", "Exp. Info",
	...
	PEPTIDE_DOMAIN_FAMILIES("Family & Domains", "Family & Domains",
			...
			PEPTIDE_MOLECULAR_PROCESSING("Molecular Processing", "Processing",
					"UniProt annnotation for describing processing events."), //
					PEPTIDE_PTM("Protein PTMs", "PTMs",
							"UniProt annnotation for described aminoacid modifications in the protein"), //
							PEPTIDE_NATURAL_VARIATIONS("Natural Variations", "Nat. variations",
									"UniProt annnotation for amino acid change(s) producing alternate protein isoforms / Description of a natural variant of the protein"), //
									PEPTIDE_SECONDARY_STRUCTURE("Secondary structure", "Sec. Struct.",
											"UniProt annnotation for protein secondary structure (helix, beta strand or turn)"), //
											PEPTIDE_EXPERIMENTAL_INFO("Experimental info", "Exp. Info",
													"UniProt experimental information"),

	// link to pride cluster
													LINK_TO_PRIDE_CLUSTER("Link to PRIDE cluster (EBI)", "PRIDE",
															"Link to information in PRIDE cluster (EBI)",
															HorizontalAlignmentSharedConstant.ALIGN_CENTER),
															// link to intAct
