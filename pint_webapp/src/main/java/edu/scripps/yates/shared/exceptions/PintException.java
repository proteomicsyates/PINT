...
public class PintException extends Exception implements Serializable {
	...
	public static enum PINT_ERROR_TYPE {
		MAX_NUM_PSMS_EXCEDED, IMPORT_PROCESS_ID_NOT_FOUND, FILE_NOT_FOUND_IN_SERVER, REMOTE_FILE_NOT_REACHABLE, PROJECT_ALREADY_IN_SERVER, REMOTE_SERVER_NOT_REACHABLE, FILE_NOT_SUPPORTED_FOR_THIS_CALL, FILE_READING_ERROR, INTERNAL_ERROR, IMPORT_XML_SCHEMA_ERROR, MOVING_FILE_ERROR, LOGIN_FAILED, QUERY_ERROR, MISSING_INFORMATION, DATA_EXPORTER_ERROR, PROJECT_NOT_FOUND, DB_ACCESS_ERROR, TEXT_FORMAT_ERROR, REACTOME_INPUT_FILE_GENERATION_ERROR, THREAD_INTERRUPTED
	};
