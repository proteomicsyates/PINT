...
public interface ContainsAmounts {
	...
	public boolean hasCombinationAmounts(String conditionName,
			String projectName);

	public List<AmountBean> getCombinationAmount(String conditionName,
			String projectName);

	public List<AmountBean> getNonCombinationAmounts(String conditionName,
			String projectName);
