...
import edu.scripps.yates.client.ui.wizard.pages.WizardPageInstruments;
...
import edu.scripps.yates.client.ui.wizard.pages.WizardPagePrincipalInvestigator;
...
// go home button
		...
		addPage(new WizardPagePrincipalInvestigator());
		addPage(new WizardPageInstruments());
