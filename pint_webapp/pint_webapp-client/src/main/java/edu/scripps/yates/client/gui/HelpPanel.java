...
public class HelpPanel extends InitializableComposite {
	...
	public HelpPanel() {
		...
		Label lblThisPageAllow = new Label("PINT help");
		...
		Label lblHowToBrowse = new Label("How to browse over data");
		...
		Label lblHowToQuery = new Label("How to query data");
		...
		Label lblHowToSubmit = new Label("How to submit data");
