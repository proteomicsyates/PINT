...
public class CustomClickableColumnProteinSequenceGraphForProteinGroup extends Column<ProteinGroupBean, Void>
	...
	public CustomClickableColumnProteinSequenceGraphForProteinGroup(ColumnName columnName, boolean visibleState,
			Header<String> footer, Header<?> header, int defaultWidth) {
	...
	public CustomClickableColumnProteinSequenceGraphForProteinGroup(ColumnName columnName, boolean visible) {
	...
	private void showPopUpDialogWithSequenceGraph(ProteinGroupBean p) {
		...
		final Label label1 = new Label(
				"Set the cursor over a portion of the protein sequence representations to see more information");
