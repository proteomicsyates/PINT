...
public class ProteinThresholdPanel
	...
	public ProteinThresholdPanel(FileTypeBean excelFileBean, ProteinThresholdTypeBean proteinThresholdTypeBean) {
		...
		final Label lblSelectExcelColumn = new Label("Select Excel column:");
		flexTable.setWidget(0, 0, lblSelectExcelColumn);
		flexTable.setWidget(1, 0, getExcelColumnRefPanel());

		final Label lblProteinAccession = new Label("Protein threshold");
		flexTable.setWidget(2, 0, lblProteinAccession);

		final Label lblGroupSeparator = new Label("Threshold name:");
		...
		final Label lblType = new Label("Threshold description:");
		...
		final Label lblyesValue = new Label("\"Yes\" value:");
	...
	public List<CustomColumn<Pair<String, ProteinThresholdTypeBean>>> getInitColumns() {
		final List<CustomColumn<Pair<String, ProteinThresholdTypeBean>>> ret = new ArrayList<CustomColumn<Pair<String, ProteinThresholdTypeBean>>>();

		final CustomColumn<Pair<String, ProteinThresholdTypeBean>> proteinAccColumn = new CustomColumn<Pair<String, ProteinThresholdTypeBean>>(
				"Protein threshold") {
			@Override
	...
	public List<Header<String>> getInitHeaders() {
		final List<Header<String>> ret = new ArrayList<Header<String>>();
		if (thresholdNameTextBox == null) {
			thresholdNameTextBox = new TextBox();
			thresholdNameTextBox.setText("My threshold");
		}
