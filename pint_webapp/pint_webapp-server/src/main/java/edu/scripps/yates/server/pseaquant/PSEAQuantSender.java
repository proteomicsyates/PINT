	...
	public PSEAQuantResult send() {
		...
		try {
			...
			while ((line = rd.readLine()) != null) {
				if (line.contains("http://pseaquant.scripps.edu/output/")) {
			...
			if (ret.getLinkToResults() == null) {
				ret.setErrorMessage(
						"Response from PSEA-Quant was not parsed correctly. Please contact to salvador at scripps.edu to get help on this issue.");
			}
