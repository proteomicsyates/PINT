...
public interface ImportWizardService extends RemoteService {
	 ...
	 * @throws PintException when the projectName is already in the database
	 */
	...
	/**
	 * Checks if the file has been uploaded before to the server or not, associated
	...
	/**
	 * Gets the current {@link PintImportCfgBean} associated to the job stated by
	 * the parameter jobID
	 *
	 * @param jobID
	 * @return
	 ...
	 *
	 * @param importJobID
	 * @param dataFileBean * @param fastaFileBean
	 * @param numTestCases
	 * @param async
	 */
	...
	public int generateNewImportProcessID() throws PintException;
	 ...
	 * @throws PintException
	 */
	public String validatePintImportCfg(PintImportCfgTypeBean pintImportCfg) throws PintException;

	/**
	 * It updates the format of a fileTypeBean and it returns the same object,
	 * unless it is an excel format file in which case it will return the object
	 * with the excel sheets populated
	 * 
	 * @param fileTypeBean
	 * @return
	 * @throws PintException
