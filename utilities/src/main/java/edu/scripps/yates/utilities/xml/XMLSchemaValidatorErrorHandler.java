...
public class XMLSchemaValidatorErrorHandler implements ErrorHandler {
	...
	public void error(SAXParseException exception) throws SAXException {
		...
		errorMessages.add(new ValidatorMessage(sb.toString(),
				MessageLevel.ERROR));
	}
	...
	public void fatalError(IOException exception) {
		...
		if (exception instanceof FileNotFoundException) {
			...
			String sub = exceptionMsg.substring(exceptionMsg
	...
	public void warning(SAXParseException exception) throws SAXException {
		...
		errorMessages
				.add(new ValidatorMessage(sb.toString(), MessageLevel.WARN));
	}
