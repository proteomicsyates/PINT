...
public class ProcessCallable implements Callable<Long> {
	...
	public ProcessCallable(long watchdogTimeout,
	...
	public Long call() throws Exception {
		...
		executor.setStreamHandler(new PumpStreamHandler(new MyLogOutputStream(
				handler, true), new MyLogOutputStream(handler, false)));
		Long exitValue;
		try {
