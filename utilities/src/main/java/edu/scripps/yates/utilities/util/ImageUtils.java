...
public class ImageUtils {
	...
	public static String saveImage(Image image, File outputFile)
			throws IOException {
	 ...
	 */
	private static String saveToFile(Image image, File outputFile)
			throws IOException {
	...
	private static void saveGraphicJpeg(BufferedImage chart, File outputFile,
