...
CREATE INDEX `fk_Protein_MS_Run1_idx` ON `interactome_db`.`Protein` (`MS_Run_id` ASC);
...
CREATE INDEX `fk_Peptide_MS_Run1_idx` ON `interactome_db`.`Peptide` (`MS_Run_id` ASC);

CREATE INDEX `sequence_index` USING BTREE ON `interactome_db`.`Peptide` (`sequence` ASC);
