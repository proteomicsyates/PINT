...
public class ColumnIndexManager {
	...
	private final Map<String, Integer> columnNameColumnIndexHash = new THashMap<String, Integer>();
	private final Map<String, Integer> columnNameSheetNumberHash = new THashMap<String, Integer>();

	private static final Logger log = Logger.getLogger(ColumnIndexManager.class);

	public ColumnIndexManager(TIntObjectHashMap<List<String>> columnNames) {

		final int[] sheetNumbers = columnNames.keys();
